...
const product = {
  ...
  benefits: [
    ...
    "Works offline ensuring uninterrupted billing",
  ],
  valuePropositions: {
    shopOwners: "Transparency in sales, profit tracking, and dealer management",
    staff: "Faster billing, easy product lookup, reduced manual effort",
    customers: "Faster checkout, accurate billing, flexible payment options",
  },
};

// Cloudinary Image URLs
const CLOUDINARY_IMAGES = [
  "https://res.cloudinary.com/dj1mlgoem/image/upload/v1759498506/MobileBilling2_fzaasa.jpg",
  "https://res.cloudinary.com/dj1mlgoem/image/upload/v1759498491/BillingSoftware3_j3k7av.jpg",
  "https://res.cloudinary.com/dj1mlgoem/image/upload/v1759498489/BillingSoftware4_zteli3.jpg"
];
