...
function Room({
 ...
 className="absolute flex w-[800px] h-[80vh] -translate-x-1/2 justify-center pointer-events-none"
 style={{
 left: `${pos}%`,
 top: "calc(3% + 80px)",
 mixBlendMode: "screen",
 ...
 <div className="relative mt-[6px] w-[54px] h-[64px] flex justify-center" style={{ perspective: "800px" }}>
 <div
 ...
 <div className="absolute pointer-events-none w-full h-[80px] bg-gradient-to-b from-black/60 to-transparent blur-xl" style={{ zIndex: 29, top: "4%", left: 0 }} />
...
export function VolumetricStudio({ className, children }) {
